...
public class AudioVisualizer : MonoBehaviour {
	 ...
	 * we need a way to assign a range to each object that gets animated. 
	 * that would be the best way to control and modify animatoins.
	*/

	void Start(){
		Debug.Log ("In Autio Visualizer");
